...
# sudo pyinstaller --onefile --noconsole --clean --hidden-import PIL._tkinter_finder bleemsyncman.py
# sudo pyinstaller --clean --hidden-import PIL._tkinter_finder bleemsyncman.py
...
games_listbox_scrollbar = tkinter.Scrollbar(games_listbox, orient=tkinter.VERTICAL, command=games_listbox.yview)
...
def write_games_list():
    ...
    for igame_data in games_list.copy():
        if igame_data['_status'] == 'changed':
            ...
            # prepare new cover art (if changed)
